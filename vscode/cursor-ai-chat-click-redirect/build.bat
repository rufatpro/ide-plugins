...
call npx vsce package -o "build\cursor-ai-chat-click-redirect-%VER%.vsix" --baseContentUrl "https://github.com/rufatpro/plugins/tree/main/vscode/cursor-ai-chat-click-redirect" > log.1main.log 2> log.1err.log
if %ERRORLEVEL% equ 0 (
