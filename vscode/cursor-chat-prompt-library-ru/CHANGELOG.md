...
- Новая категория **Zig** (20 промптов).
- Всего шаблонов: **1300** (53 категории).

## 0.6.5

- Новая категория **Android (Kotlin)** (20 промптов).
- Всего шаблонов: **1280** (52 категории).

## 0.6.4

- Новая категория **Android (Java)** (20 промптов).
- Всего шаблонов: **1260** (51 категория).

## 0.6.3

- Новые категории (по 20 промптов): **Angular**, **Kotlin**, **Kafka**, **RabbitMQ**, **Swift**, **Regex**, **Celery**, **PostgreSQL**.
- Всего шаблонов: **1240** (50 категорий).

## 0.6.2

- Новая категория **SQLAlchemy** (20 промптов): Engine, ORM 2.0, связи, Alembic, async, FastAPI, тесты.
- Всего шаблонов: **1080** (42 категории).

## 0.6.1

- Синхронизация с EN **0.8.3–0.8.4**: по **50** промптов в **JavaScript**, **TypeScript**, **React**, **Next.js**, **Tailwind CSS**, **Node.js Backend**, **NestJS** (batch 3, 21–50, русские переводы).
- Всего шаблонов: **1060** (41 категория; Python × 50, JS-стек + NestJS × 50, остальные × 20).
