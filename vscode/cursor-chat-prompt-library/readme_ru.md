...
**850 шаблонов** — 41 категория (**Python × 50**, остальные × 20):
...
| Клавиша | Действие |
|---------|----------|
| **Ctrl+Alt+T** | **Шаг 1:** категория (41 тип) → **шаг 2:** промпт → вставка в чат |
...
| **Insert Prompt into Chat (All Categories)** | Один список из 850 промптов |
