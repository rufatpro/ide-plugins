...
| [Cursor Chat Prompt Library](vscode/cursor-chat-prompt-library/) | VS Code / Cursor | 0.8.9 | **Ctrl+Alt+T** (основной), **Ctrl+Alt+Shift+P** → **AI-чат**; **1300** шаблонов, **53** категории | [EN](vscode/cursor-chat-prompt-library/readme.md) · [RU](vscode/cursor-chat-prompt-library/readme_ru.md) |
| [Cursor Chat Prompt Library RU](vscode/cursor-chat-prompt-library-ru/) | VS Code / Cursor | 0.6.6 | **1300** русских шаблонов, **53** категории; **Ctrl+Alt+Shift+P**; параллельно с EN | [RU](vscode/cursor-chat-prompt-library-ru/readme.md) · [EN](vscode/cursor-chat-prompt-library-ru/readme_en.md) |
| [Cursor AI Chat Click Redirect](vscode/cursor-ai-chat-click-redirect/) | VS Code / Cursor | 0.6.6 | **AI-чат** → внешняя IDE по расширению; редирект только при **новой вкладке** (не если файл уже открыт / клик по табу); опциональный лог | [EN](vscode/cursor-ai-chat-click-redirect/readme.md) · [RU](vscode/cursor-ai-chat-click-redirect/readme_ru.md) |
